...
enum message_type{PINGO, GAME_SET, GAME_START, PLAYER_UPDATE, PLAYER_SET, ROCK_SET, SPIKE_SET, COIN_SET, COIN_UPDATE, BONUS_SET, BONUS_UPDATE,
	...
	TRANSITION_UPDATE, BOSS_SET, BOSS_UPDATE, BALL_SET, BALL_UPDATE, PLATFORM_SET, CHANGE_LEVEL, PLAYER_DEAD, GAME_OVER, GAME_WON, MESSAGE_TOTAL};
enum key_event {PING, LEFT_UP, LEFT_DOWN, RIGHT_UP, RIGHT_DOWN, SPACE_UP, SPACE_DOWN, DOWN_DOWN,DOWN_UP, UP_DOWN, QUIT, START_GAME, START_TEAM_1, START_TEAM_2, RECONNECTION, KEY_TOTAL};
enum state_type{NORMAL,INVENCIBLE,ESCUDO,PRUEBA,REVIVIENDO};
enum move_type{IDLED, IDLEI, JUMPD, JUMPI, RUND, RUNI, WALKD, WALKI, WAITD, WAITI, BRAKED, BRAKEI, BALLD, BALLI, DMGD, DMGI, CROUCHD, CROUCHI,ROLLI,ROLLD,CRABI,
	CRABD,FLYL,FLYD, BOSSL, BOSSR, FISHU,FISHD, DIE, MOVE_TOTAL};
//IDLE es parado
//JUMP es saltando
//RUN es corriendo
//WALK es caminando
...
enum gameMode{INDIVIDUAL=0,COOP,EQUIPOS};
