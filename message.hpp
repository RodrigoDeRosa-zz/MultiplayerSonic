...
enum key_event {PING, LEFT_UP, LEFT_DOWN, RIGHT_UP, RIGHT_DOWN, SPACE_UP, SPACE_DOWN, DOWN_DOWN, DOWN_UP, UP_DOWN, UP_UP, QUIT, START_GAME,
	START_TEAM_1, START_TEAM_2, RECONNECTION, KEY_TOTAL};
