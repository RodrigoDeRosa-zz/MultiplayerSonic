...
enum message_type{PINGO, GAME_SET, GAME_START, PLAYER_UPDATE, PLAYER_SET, ROCK_SET, SPIKE_SET, COIN_SET, COIN_UPDATE, BONUS_SET,  BONUS_UPDATE,
	FISH_SET, FISH_UPDATE, FLY_SET, FLY_UPDATE, CRAB_SET, CRAB_UPDATE, INVENCIBILITY_SET, INVENCIBILITY_UPDATE, SHIELD_SET, SHIELD_UPDATE, COINBONUS_SET, COINBONUS_UPDATE, MESSAGE_TOTAL};
